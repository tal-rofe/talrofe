			...
			{projectsItems.map((projectItem, index) => (
				...
				>
					<div className="relative flex items-center">
						{projectItem.isHighlighted && <MdStars size="40" className="absolute -left-4 -top-4" />}
						{projectItem.imageFileName && (
							<div className="mr-2 flex-initial flex-shrink-0 justify-center sm:mr-3">
								<Image
									className="rounded-lg"
									src={`/images/${projectItem.imageFileName}`}
									width="75"
									height="75"
						...
						<div className="my-3 mr-2 flex flex-col justify-center sm:mt-[-1px]">
							<h3 className="mb-0.5 text-2xl font-bold sm:text-3xl">{projectItem.title}</h3>
							...
							<div className="mt-3 flex flex-wrap gap-1.5 opacity-90 sm:mt-3">
								{projectItem.metadata.map((metadataLink, innerIndex) => (
